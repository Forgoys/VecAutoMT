...
#undef __NR_newstat
#define __NR_newstat 195
#define SYS_newstat __NR_newstat
#undef __NR_newlstat
#define __NR_newlstat 196
#define SYS_newlstat __NR_newlstat
#undef __NR_newfstat
#define __NR_newfstat 197
#define SYS_newfstat __NR_newfstat
#undef __NR_chown32
...
#undef __NR_cache_sync
#define __NR_cache_sync 330
#define SYS_cache_sync __NR_cache_sync
